        ...
        <b-card>
          <div>
            ...
            <div>
              ...
              <img v-if="this.item.image_path_2" :src="`http://localhost:8000/${this.item.image_path_2}` " />
...
export default {
  ...
  methods: {
    async readItem() {
      ...
      console.log(this.item.image_path)
      console.log(this.item.image_path_2)

      const imagepath =this.item?.image_path?.replace('public', 'storage')
      const imagepath_2 =this.item?.image_path_2?.replace('public', 'storage')

      console.log('123123' + imagepath)
      this.item.image_path = imagepath

      console.log('124124124124124124' + imagepath_2)
      this.item.image_path_2 = imagepath_2
